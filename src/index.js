...
function callApi(event) {
  ...
  let prompt = `Generate a product description about ${userProductName.value} `;
  let context = `Use the provided product details ${userProductDetails.value} to create an attractive and concise 100 words product description.`;
